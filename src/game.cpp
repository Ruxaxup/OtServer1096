...
{	
	...
	if (damage.primary.value > 0) {
		...
		std::cout << "2-Primary Damage: " << damage.primary.value << std::endl;
		std::cout << "2-Secondary Damage: " << damage.secondary.value << std::endl;
		...
		//std::cout << "Health Change " << healthChange << std::endl;
		if (healthChange == 0) {
			return true;
		}
