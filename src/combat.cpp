...
void Combat::CombatHealthFunc(Creature* caster, Creature* target, const CombatParams& params, CombatDamage* data)
{
	...
	//std::cout << "Block shield: " << params.blockedByShield << " -- Block Armor: " << params.blockedByArmor << std::endl;
	if (g_game.combatBlockHit(damage, caster, target, params.blockedByShield, params.blockedByArmor, params.itemId != 0)) {
		return;
	}
	//std::cout << "2-COMBAT Primary Damage: " << damage.primary.value << std::endl;
	//std::cout << "2-COMBAT Secondary Damage: " << damage.secondary.value << std::endl;
...
{
	//std::cout << "doCombat:: line 757: " << std::endl;
...
{
	//std::cout << "doCombat:: line 775: " << std::endl;
...
{
	//std::cout << "-doCombatHealth" << std::endl;
